...
public class CommentController {
    ...
    //The method redirects to '/images/{imageId}/{title}' mapped to showImage method of ImageController
    //This method takes is user added comment text as a request parameter and creates a new comment object
    //Adds comment to commentList in Image
    ...
    public String createComment(@PathVariable("title") String title, @PathVariable("imageId") Integer imageId, @RequestParam("comment") String comment, HttpSession session, Model model) {
        ...
        //create a new comment and setting all attribute values
